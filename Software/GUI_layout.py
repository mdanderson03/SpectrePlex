...
layout_cycle = [[sg.Text("Directory:"), sg.Input(key="-path-"), sg.FolderBrowse(target="-path-")],
                ...
                [sg.Checkbox("Change Incubation Time (45 min)", key="-incub_time-", enable_events=True), sg.Text("Incubation Time:", key="-fc_incub_txt-", visible=False), sg.Input(key="-fc_incub_input-", visible=False, size=(10,1))]]
