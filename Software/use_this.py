...
#microscope.wide_net_auto_focus(experiment_directory, x_frame_size=x_frame_size, offset_array=offset_array, z_slice_search_range=7, focus_position=focus_position, number_clusters_retained=2, manual_cluster_update=0)
...
#    microscope.full_cycle(experiment_directory, cycle, offset_array, cycle, pump, z_slices, incub_val = 45, x_frame_size=x_frame_size,focus_position=focus_position)

#pump.clean_valve()

microscope.inter_cycle_processing(experiment_directory, 2, x_frame_size=x_frame_size)
