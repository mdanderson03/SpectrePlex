...
experiment_directory = r'D:\delete'
#pump = fluidics(6,5,7)
pump = 1
...
microscope.image_cycle_acquire(1, experiment_directory, z_slices, 'Stain', offset_array,x_frame_size=x_frame_size, establish_fm_array=1, auto_focus_run=0,auto_expose_run=3)
