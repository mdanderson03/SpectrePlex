...
experiment_directory = r'D:\10_3_26_s_22_9002'
pump = fluidics(6,5,7)
...
#microscope.wide_net_auto_focus(experiment_directory, x_frame_size=x_frame_size, offset_array=offset_array, z_slice_search_range=11, focus_position=focus_position, number_clusters_retained=2, manual_cluster_update=0)
