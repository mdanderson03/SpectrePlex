...
experiment_directory = r'E:\delete_again'
...
#pump.liquid_action('Bleach')
microscope.image_cycle_acquire(0, experiment_directory, z_slices, 'Stain', offset_array, x_frame_size=x_frame_size, establish_fm_array=0, auto_focus_run=0, auto_expose_run=0)
